...
class StrategyLearner3(object):
    # Constants for positions and order signals
    LONG = 1
    CASH = 0
    SHORT = -1

    def __init__(self, feature_list, num_shares=1000, epochs=100, num_steps=5,
        ...
        **kwargs: Arguments for QLearner
        ...
        for _ in symbols:
            ...
            df_features = get_feature_file("Features", symbol)
    ...
    def get_thresholds(self, start_date=None, end_date=None):
        ...
        df = pd.read_csv("../Data/average_copy.csv", index_col='Datetime',
