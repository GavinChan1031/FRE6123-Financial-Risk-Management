"""Implement a StrategyLearner2 that only contains techinical indicators"""
...
from util import get_feature_file, create_df_benchmark, bi_to_decimal

class StrategyLearner2(object):
    # Constants for positions and order signals
    LONG = 1
    CASH = 0
    SHORT = -1

    def __init__(self, num_shares=1000, epochs=100, num_steps=5,
        ...
        **kwargs: Arguments for QLearner
        ...
        self.q_learner = ql.QLearner(num_states=2**6)
        self.MAX = 6
        ...
        for _ in symbols:
            ...
            df_features = df_features[self.technicals+['Symbol', 'Close', 'Returns']]
    ...
    def get_thresholds(self, start_date=None, end_date=None):
        ...
        self.technicals = ['RDSkew','down_vol_ratio','late_trans_ratio','vol_price_corr','avg_trans_outflow_ratio','large_order_drives_gain']
    ...
    def add_evidence(self, start_date=dt.datetime(2021,1,1),
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            df_sub = self.datafull.iloc[random_nums]
