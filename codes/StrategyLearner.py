...
from util import get_data, get_feature_file, create_df_benchmark, create_df_trades, bi_to_decimal
...
if __name__=="__main__":
    ...
    market_simulator(symbol, df_trades, df_benchmark_trades, prices=prices.copy(), 
        start_val=start_val, commission=commission, impact=impact, fig_name=fig_name, verbose=True)
